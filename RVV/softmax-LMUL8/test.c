...
void softmax_stable_rvv_fp32(float* dst, float* src, size_t n)
{
    ...
    vuint32m8_t ptable_u = __riscv_vle32_v_u32m8(coeff_bits, vl_table);
    ...
    for (size_t avl2 = n; avl2 > 0; ) {
        ...
        // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vx_f32m8(ptable, 8, vl), vl); // +C0
            ...
            // vfloat32m8_t p = __riscv_vrgather_vi_f32m8(ptable, 0, vl); // C8
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 1, vl), vl); // +C7
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 2, vl), vl); // +C6
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 3, vl), vl); // +C5
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 4, vl), vl); // +C4
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 5, vl), vl); // +C3
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 6, vl), vl); // +C2
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 7, vl), vl); // +C1
            // p = __riscv_vfmadd_vv_f32m8(p, vr, __riscv_vrgather_vi_f32m8(ptable, 8, vl), vl); // +C0

            // vfloat32m8_t p = __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 0, vl)); // C8
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
            //     __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 1, vl)), vl);
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
            //     __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 2, vl)), vl);
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
            //     __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 3, vl)), vl);
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
            //     __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 4, vl)), vl);
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
            //     __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 5, vl)), vl);
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
            //     __riscv_vreinterpret_v_u32m8_f32m8(__riscv_vrgather_vi_u32m8(ptable_u, 6, vl)), vl);
            // p = __riscv_vfmadd_vv_f32m8(p, vr,
